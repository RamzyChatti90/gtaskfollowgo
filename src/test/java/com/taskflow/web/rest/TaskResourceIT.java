...
import static com.taskflow.web.rest.TestUtil.createUpdateProxyForBean;
...
import com.taskflow.IntegrationTest;
import com.taskflow.domain.Task;
import com.taskflow.repository.TaskRepository;
import com.taskflow.service.TaskService;
import com.taskflow.service.dto.TaskDTO;
import com.taskflow.service.mapper.TaskMapper;
...
class TaskResourceIT {
    ...
    private static final String UPDATED_STATUS = "TODO";
    ...
    void partialUpdateTaskWithPatch() throws Exception {
        ...
        partialUpdatedTask.title(UPDATED_TITLE).dueDate(UPDATED_DUE_DATE).status(UPDATED_STATUS).updatedAt(UPDATED_UPDATED_AT);
