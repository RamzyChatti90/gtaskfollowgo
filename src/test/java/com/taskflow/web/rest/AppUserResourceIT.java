...
class AppUserResourceIT {
    ...
    private static final String DEFAULT_EMAIL = "fQX*\"@U.$%";
    private static final String UPDATED_EMAIL = "q@MF.Sc$eqm";
    ...
    void partialUpdateAppUserWithPatch() throws Exception {
        ...
        partialUpdatedAppUser.login(UPDATED_LOGIN).firstName(UPDATED_FIRST_NAME).activated(UPDATED_ACTIVATED);
